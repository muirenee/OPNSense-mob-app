...
class ApiCapabilityProbe {
  ...
  static const probes = <({String id, String label, String path})>[
    ...
    (id: 'firewallRules', label: 'Firewall Automation rules', path: '/api/firewall/filter/search_rule'),
    (id: 'firewallAliases', label: 'Firewall aliases', path: '/api/firewall/alias/search_item'),
    (id: 'portForward', label: 'NAT port forwards', path: '/api/firewall/d_nat/search_rule'),
